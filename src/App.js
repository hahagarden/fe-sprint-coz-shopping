...
function App() {
  ...
  useEffect(() => {
    ...
    if (!localStorage.getItem(StorageKey.BOOKMARKS)) localStorage.setItem(StorageKey.BOOKMARKS, JSON.stringify([]));
    dispatch(init(JSON.parse(localStorage.getItem(StorageKey.BOOKMARKS))));
  }, []);
